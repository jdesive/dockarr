...
# Searcharr Bot
searcharr_password = "example"  # Used to authenticate as a regular user to add series/movies
searcharr_admin_password = "adminExample"  # Used to authenticate as admin to manage users
